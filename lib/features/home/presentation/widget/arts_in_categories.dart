...
class _ArtViewState extends ConsumerState<ArtView> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content:
              SmallText(text: 'Are you sure you want to delete "$artTitle"?'),
          actions: [
            TextButton(
              onPressed: () {
            ...
            TextButton(
              ...
              child: const SmallText(text: 'Delete'),
            ),
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    final gap = SizedBox(height: isTablet ? 16.0 : 15.0);
                                ...
                                if (isCurrentUserPost) // Show edit and delete icons only if the user is logged in
                                  Row(
                                    children: [
                                      Container(
                                        decoration: BoxDecoration(
                                          color: AppColorConstant.lightColor,
                                          borderRadius:
