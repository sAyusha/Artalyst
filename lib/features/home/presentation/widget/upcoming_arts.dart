...
class ImageItem {
  ...
  ImageItem(this.artId, this.title, this.image, this.isUserLoggedIn);
}
...
void retrieveAlertStatusFromSharedPreferences() async {
  SharedPreferences prefs = await SharedPreferences.getInstance();
  Map<String, dynamic> retrievedAlerts = jsonDecode(prefs.getString('alertStatus') ?? '{}');
  setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    List<HomeEntity> upcomingArts =
        homeList.where((art) => art.artType == "Upcoming" && art.artId != null).toList();
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundColor: isAlert
                              ? AppColorConstant.blackTextColor.withOpacity(0.7)
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          padding: isTablet
                              ? EdgeInsets.all(
                                  AppColorConstant.kDefaultPadding / 4)
                              : EdgeInsets.all(
                                  AppColorConstant.kDefaultPadding / 3),
